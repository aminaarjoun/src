...
<div id="contenido">
    ...
    <div class="contacto" id="NewContacto" onclick="revealModal('modalPage')" onmouseover="Over();" onmouseout="Out();">
        <img align="left" src="img/edit_add.png" alt="Nuevo Contacto"/>
            <h2>Agregar Nuevo...</h2>
    </div>
   ...
   <% for (int i = 0; i < lst.Count; i++)
    ...
    <div class="contacto">
            <% if (lst[i].EsHombre)
               { %>
               <img align="left" src="img/user_male.png" alt="<% Response.Write( lst[i].Nombre); %>" />
            <%}else{ %>
               <img align="left" src="img/user_female.png" alt="<% Response.Write( lst[i].Nombre); %>" />
            <%} %>
            <p><span><strong><% Response.Write(lst[i].Nombre + " " + lst[i].Apellido); %></strong></span>
            <span><img src="img/cake.png" alt="cake" />
            <% Response.Write(lst[i].FechaNacimiento.ToString("dd/MM/yyyy")); %></span>
            <br />
            <span><% Response.Write(lst[i].Mail); %></span>
            <br />
            <span><% Response.Write(lst[i].Celular); %></span>
        </p>
    </div>
    <%} %>
    </div>
